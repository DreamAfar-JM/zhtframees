...
<!-- ---------------------------------------继承获得--------------------------------------------------------------------   -->
<div data-options="region:'west',border:true,split:true,collapsible:true" title="继承角色" 
		style="overflow:hidden;padding: 0px;width:30%;height: 100%">
	<div class="easyui-layout" data-options="fit:true,border:false">
		<div data-options="region:'north',border:true ,split:false" title="继承自用户组的角色"style="overflow:hidden;padding: 0px;height:50%">
			<table id="table_FromUserExtendsGroup"></table>
		</div>
		<div data-options="region:'south',border:true ,split:false" title="继承自部门的角色"style="overflow:hidden;padding: 0px;height:50%">
			<table id="table_FromUserExtendsDepartment"></table>
		</div>	
	</div>
</div>
<!-- -----------------------------------------------------------------------------------------------------------   -->

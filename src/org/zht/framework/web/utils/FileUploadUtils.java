...
import org.zht.framework.util.MD5Util;
...
public class FileUploadUtils {
    ...
    public static final long DEFAULT_MAX_SIZE = 52428800*2;
    ...
    private static final String encodingFilename(String filename) {
        ...
        filename = MD5Util.encode(filename + System.nanoTime() + counter++) + "_" + filename;
        return filename;
    }

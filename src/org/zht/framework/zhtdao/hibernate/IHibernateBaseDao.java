...
public interface IHibernateBaseDao {
    ...
    public Long findTotalCount(Class<?> clazz)throws DataAccessException;
	...
	//-------------------saveOrUpdate------------
	//如果对象已经在本session中持saveOrUpdate化了，不做任何事 
	 ...
	 * @param selfUniqueFieldName
	 * @param selfUniqueFieldValue
	 * @return
	 */
	...
	public DataSet loadDataSetFromOneEntity(Class<?> clazz,ParamObject paramObject,RowMap rowMap)throws DataAccessException;

...
import com.zht.common.generator.model.LookUpType;
import com.zht.common.generator.model.RelationType;

public class RelationTypeSelect extends SimpleTagSupport{
	private String name;
	private String id;
	...
	private String createSelet() {
		...
		for(RelationType value:relationTypes){  

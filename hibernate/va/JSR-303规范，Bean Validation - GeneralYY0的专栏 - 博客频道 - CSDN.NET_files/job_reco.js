...
<div id="job_myhome_reco">
 ...
 <div id="job_csto_my_reco">
   ...
   searchKey: "NO",
   username: "当前登录用户名",
   containerId: "job_csto_my_reco"  //容器DIV的id。
   });
   </script>
 </div>
...
(function (window) {
  ...
  Position.prototype = {
    ...
    get_url: function(un, searcht, key, st, tt) {
      var _st = st;

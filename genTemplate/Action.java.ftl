...
/*--------------------------------Detail------------------------------------------------*/  
	...
	public String enter${model.entitySimpleClassName}Detail(Model model , Serializable id) throws Exception {	
...
/*---------------------------Update-----------------------------------------------------*/    
	...
	@RequestMapping(value="/enterUpdate${model.entitySimpleClassName}") 
 	public String enterUpdate${model.entitySimpleClassName}(Model model , Serializable id) throws Exception {
		${model.entitySimpleClassName} ${model.entitySimpleClassName ? uncap_first }=${model.entitySimpleClassName ? uncap_first}Service.$base_find(id);
		setDataAttribute(model,${model.entitySimpleClassName ? uncap_first },"${model.entitySimpleClassName ? uncap_first }");
...
/*------------------------------simpleDelete--------------------------------------------------*/    
    ...
    public Object simpleDelete${model.entitySimpleClassName}(Serializable id) throws Exception {
